...
import { CHOOSE_MENU, OPEN_OR_CLOSE_MENU } from '../../lib/actions';
...
export default function Menu() {
  ...
  return (
    <div>
      <div
        className={classNames('md:hidden flex flex-col w-full', {
      ...
      {/* desktop view */}
      <div className='items-center justify-between hidden w-full mt-8 md:flex'>
        {/* logo and links */}
        <div className='flex items-center'>
          {/* logo */}
          <Link href='/'>
            <div className='w-[76px] h-[76px] rounded-full relative border'>
              <Image
          ...
          <div className='flex items-center ml-[80px]'>
            <Link href='/'>
              <h2
                className={classNames(' base-text', {
            ...
            <Link href='/'>
              <h2
                className={classNames(' base-text ml-8', {
                  'font-bold ': pathname.includes('new'),
                })}
              >
                Identification
              </h2>
            ...
            <Link href='/'>
              <h2
                className={classNames(' base-text ml-8', {
                  'font-bold': pathname.includes('about'),
                })}
              >
                About
              </h2>
        ...
        <div className='flex items-center'>
          {/* avatar */}
          <div className='h-[65px] w-[65px] relative border rounded-full'>
            <Image
              src='https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8dXNlcnxlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60'
              layout='fill'
              objectFit='cover'
          ...
          <div className='flex flex-col ml-2'>
            <p className='ml-2 font-bold base-text'>Admin</p>
            <button className='rounded-full w-[125px] h-[40px] font-semibold base-text text-white bg-[#2521E4]'>
              Deconnexion
            </button>
          </div>
        </div>
